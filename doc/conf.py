# -*- coding: utf-8 -*-
#
# optimalneuron documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../examples/example_1'))
...
MOCK_MODULES = ['scipy','scipy.stats','inspyred','inspyred.ec','ec','numpy','random','time','neuron']
