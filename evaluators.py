...
class IClampEvaluator(__Evaluator):
    ...
    def __init__(self,analysis_start_time,controller,
        ...
        if automatic==True:
            from nrndev import nrnanalysis
            import numpy
            t,v_raw=nrnanalysis.load_csv_data(target_data_path)
            v=numpy.array(v_raw)
            v_smooth=list(nrnanalysis.smooth(v))
            analysis=nrnanalysis.IClampAnalysis(
    ...
    def evaluate(self,candidates,args):
        ...
        for exp_data in exp_data_array:
            ...
            analysis=nrnanalysis.IClampAnalysis(exp_data.samples,
            ...
            exp_fitness=analysis.evaluate_fitness(self.targets,
                                                  ...
                                                  nrnanalysis.normalised_cost_function)
...
class IClampCondorEvaluator(IClampEvaluator):
    ...
    def __local_evaluate(self,candidates,args):
        ...
        for CandidateData in self.CandidateData_list:
            ...
            analysis=nrnanalysis.IClampAnalysis(exp_data.samples,exp_data.t,analysis_var,5000,10000)
            exp_fitness=analysis.evaluate_fitness(optimizer_params.targets,optimizer_params.weights,cost_function=nrnanalysis.normalised_cost_function)
            fitness.append(exp_fitness)
