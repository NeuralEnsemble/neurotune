...
extern int nrn_get_mechtype();
 ...
 "setdata_kv_3", _hoc_setdata,
 "rates_kv_3", _hoc_rates,
 "trates_kv_3", _hoc_trates,
 0, 0
};
...
#define tha tha_kv_3
 double tha = 25;
#define tadj tadj_kv_3
 double tadj = 0;
#define temp temp_kv_3
 double temp = 23;
#define usetable usetable_kv_3
 double usetable = 1;
#define vmax vmax_kv_3
 double vmax = 100;
#define vmin vmin_kv_3
 double vmin = -120;
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 kv_3 /home/mike/dev/neurotune/examples/example_1/x86_64/Kv_3_erisir_99.mod\n");
...
static int  rates (  _lv )  
	double _lv ;
 {
   a = ( 95.0 - _lv ) / ( exp ( ( - 95.0 + _lv ) / - 11.8 ) - 1.0 ) ;
   b = 0.025 / ( exp ( _lv / 22.222 ) ) ;
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 73 in file Kv_3_erisir_99.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
