...
if __name__ == "__main__":
    ...
    surrogate_analysis = analysis.NetworkAnalysis(
        volts, times, analysis_var, start_analysis=0, end_analysis=1000
    )
    ...
    fit_analysis = analysis.NetworkAnalysis(
        fit_volts, fit_times, analysis_var, start_analysis=0, end_analysis=1000
    )
